...
export default function Auth() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === "login") {
        ...
        if (
          role === "doctor" &&
          !ALLOWED_DOCTOR_EMAILS.includes(form.email.toLowerCase())
        ) {
          setLoading(false);
  ...
  const handleRoleSelection = async (selectedRole) => {
    ...
    if (
      selectedRole === "doctor" &&
      !ALLOWED_DOCTOR_EMAILS.includes(googleUser.email.toLowerCase())
    ) {
          ...
          >
            ...
            >
              ...
              <p style={{ color: "#64748b", fontSize: 15, marginBottom: 32 }}>
                Welcome to MediAI! Please select your role to continue.
              </p>
